...
def parse_opts():
    ...
    parser.add_argument('--num_frame_steps', default=16, type=int, help='Number of frame steps')
    parser.add_argument('--output_dir', default='data/feats/c3d', type=str, help='Output file path')
